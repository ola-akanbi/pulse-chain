...
![PulseChain Logo](./public/logo.png)
...
```bash
# Clone repository
git clone https://github.com/nirwanadoteth/pulse-chain.git
cd pulse-chain
...
PulseChain is a modern Web3 application that enables users to say "GM" (Good Morning) daily across multiple blockchain networks, track engagement streaks, and earn configurable USDC rewards. Built with Farcaster, Base, and SpaceTimeDB, PulseChain demonstrates seamless integration between decentralized social, smart contracts, and real-time data.

---

## 🚀 Overview

PulseChain empowers users to:

- Record daily "GM" messages on-chain
- Track and visualize streaks across supported blockchains
- Earn USDC rewards for consistent participation
- Experience real-time updates and a responsive, user-friendly interface

## ✨ Features

- Multi-chain streak tracking
- Farcaster and Base blockchain integration
- USDC reward system
- Real-time updates with SpaceTimeDB
...
```bash
git clone https://github.com/ola-akanbi/pulse-chain.git
cd pulse-chain
```
...
Configure environment variables as needed (see `.env.example` if available).
...
- [Live Demo](https://pulse-chain.nirwana.lol)
...
Please review our guidelines and code of conduct before contributing.
...
⭐ [Star us on GitHub](https://github.com/ola-akanbi/pulse-chain) • 🐛 [Report Issues](https://github.com/ola-akanbi/pulse-chain/issues)
### Reward System
...
⭐ [Star us on GitHub](https://github.com/nirwanadoteth/pulse-chain) • 🐛 [Report Issues](https://github.com/nirwanadoteth/pulse-chain/issues)
